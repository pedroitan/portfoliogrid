        ...
        >
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-gray-900/50 p-6 rounded-lg">
              ...
              <a
                href={`https://wa.me/5521988419463?text=${encodeURIComponent(t('whatsappMessage'))}`}
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center justify-center gap-2 mt-5 w-full py-2.5 rounded-lg bg-[#25D366] hover:bg-[#1ebe5d] text-white font-medium transition"
              ...
              <div className="flex justify-center space-x-4 mt-4">
                <a href="https://instagram.com/pedro.itan" target="_blank" rel="noopener noreferrer" className="text-white hover:text-gray-300 transition" aria-label="Instagram">
